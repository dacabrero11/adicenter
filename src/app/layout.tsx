...
const SITIO = "https://adicenter.net";
const DESCRIPCION =
...
export const metadata: Metadata = {
  // metadataBase resuelve las rutas relativas de Open Graph; sin esto las
  // vistas previas al compartir el enlace salen sin imagen.
