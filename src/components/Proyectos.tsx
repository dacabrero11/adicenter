...
export function Proyectos({ onAskJimmy }: { onAskJimmy: (mensaje?: string) => void }) {
  ...
  return (
    <InView className="cv-section relative text-ink">
      ...
      <section id="proyectos" className="relative z-2 py-19 lg:py-24">
                ...
                <div className="flex flex-1 flex-col p-5.5">
                  ...
                  <div className="mt-4.5 flex flex-wrap gap-4 border-t border-navy/[.11] pt-4">
                    ...
                    <span className="ml-auto flex items-center self-end">
                      <button
                        onClick={() => onAskJimmy(`Cuéntame sobre el proyecto ${p.nombre} en ${p.ubicacion}`)}
                        ...
                        aria-label="Preguntar a Jimmy sobre este proyecto"
                      >
