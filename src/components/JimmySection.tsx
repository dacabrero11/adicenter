        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[.85fr_1.15fr] lg:gap-8">
          <Reveal as="div" className="flex items-center justify-center gap-2 sm:gap-5">
            ...
            <div className="relative flex-none">
              ...
              />
              <J1MMYAnimado />
              <div className="absolute -right-3 -top-4 z-10 flex items-center gap-1.5 rounded-full border border-navy/[.14] bg-white px-2.5 py-1.25 shadow-[0_8px_20px_-8px_rgba(1,35,135,.35)] sm:-right-6 sm:-top-5">
