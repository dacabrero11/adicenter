...
export function Tecnologias({ onAskJ1MMY }: { onAskJ1MMY?: (m?: string) => void }) {
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className="text-[13px] text-white/55">
                  J1MMY puede analizar su caso y recomendarle el sistema adecuado en segundos.
                </span>
              </div>
            </div>
            <button
              onClick={() => onAskJ1MMY("Quisiera saber qué tecnología de impermeabilización es la adecuada para mi superficie")}
