...
/* ---------- íconos naranja para los beneficios ---------- */
const ICONOS = [
  /* 01 escala precio */
...
const BENEFICIOS = [
  ...
  { n: "02", titulo: "Asesor técnico en sitio", texto: "Visita de diagnóstico sin costo, prueba de adherencia y acta de arranque." },
  { n: "03", titulo: "Capacitación de cuadrillas", texto: "Taller de aplicación con su personal antes de iniciar el metraje." },
  { n: "04", titulo: "Garantía por escrito", texto: "Póliza del sistema completo hasta 10 años, condicionada a aplicación supervisada." },
  { n: "05", titulo: "Entrega programada", texto: "Despacho por etapas al frente de obra, sin bodega muerta." },
];
...
const STATS = [
  ...
  },
  {
    ...
    valor: String(BENEFICIOS.length),
    label: "Beneficios",
