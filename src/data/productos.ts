...
export const productos: Producto[] = [
  ...
  },
  {
    ...
    nombre: "SikaCeram®-252",
    descripcion:
      "Adhesivo cementoso para instalación de azulejos, mosaicos, gresite y otros revestimientos cerámicos sobre el sistema impermeabilizado. Proporciona adherencia y deformabilidad adecuadas para condiciones de servicio de piscina.",
    specs: [
      ["Marca", "Sika®"],
  ...
  },
  {
    categoria: "imper",
    marca: "ADMIX",
    familia: "Impermeabilización",
    nombre: "ADMIX Politflex SL",
    descripcion:
      "Membrana líquida autonivelante de la línea ADMIX para impermeabilización de superficies horizontales. Forma una capa continua y elástica sin traslapes.",
    specs: [
      ["Marca", "ADMIX"],
      ["Tipo", "Autonivelante (SL)"],
      ["Aplicación", "Superficies horizontales"],
    ],
  },
];
