...
export const servicios: Servicio[] = [
  {
    ...
    img: "/images/catalogo/refuerzo.webp",
  ...
  {
    n: "10",
    slug: "reparacion-profundidad-parcial",
    categoria: "reparacion",
    titulo: "Reparación a profundidad parcial",
    img: "/images/sistemas/reparacion-profundidad.webp",
    imgAlt: "Reparación a profundidad parcial en losa de concreto con mortero de reparación",
    descripcion:
      "Remoción del concreto deteriorado y reposición con mortero de reparación de fraguado rápido, para recuperar la sección sin intervenir todo el elemento.",
    specs: [
      ["Sistema", "SikaQuick® 2500 / ADMIX SR"],
      ["Aplicación", "Losas y elementos de concreto"],
      ["Ventaja", "Habilitación rápida"],
    ],
  },
];
